...
if submitted:
    ...
    if ai_country_name:
        ...
        # 【修正箇所】ここを serpapi_key ではなく serpapi_api_key に修正しました
        ...
        # 【修正箇所】ここも serpapi_key ではなく serpapi_api_key に修正しました
        image_urls = get_images(ai_country_name, serpapi_api_key, num_images=5)
